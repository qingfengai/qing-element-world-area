...
```js
import { provinceAndCityData, regionData, provinceAndCityDataPlus, regionDataPlus, CodeToText, TextToCode } from 'element-world-area'
```
服务端用法：
```js
const { provinceAndCityData, regionData, provinceAndCityDataPlus, regionDataPlus, CodeToText, TextToCode } = require('element-world-area/dist/app.commonjs')
```
  ...
  * 省市二级联动（不带“全部”选项）:
    ...
    <script>
      import { provinceAndCityData } from 'element-world-area'
      export default {
        data () {
          return {
    ...
    * 省市二级联动（带“全部”选项）:
      ...
      <script>
        import { provinceAndCityDataPlus } from 'element-world-area'
        export default {
          data () {
            return {
    ...
    * 省市区三级联动（不带“全部”选项）
    ...
    <script>
      import { regionData } from 'element-world-area'
      export default {
        data () {
          return {
            options: regionData,
    ...
    * 省市区三级联动（带“全部”选项）
    ...
    <script>
      import { regionDataPlus } from 'element-world-area'
      export default {
        data () {
          return {
